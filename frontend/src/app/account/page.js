...
export default function AccountPage() {
  ...
  useEffect(() => {
    ...
    else reset({ name: user?.name, phone: user?.phone || '', address: user?.address || '' });
  }, [user]);
          ...
          <div className="card p-6">
            ...
            <form onSubmit={handleSubmit(d => mutation.mutate(d))} className="space-y-4">
              <div>
                ...
                <input {...register('name', { required: 'Tələb olunur', minLength: { value: 2, message: 'Min 2 hərf' } })}
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">E-poçt adresi dəyişdirilə bilməz</p>
              </div>
              <div>
